    ...
    return (
      <Aux>
        <Navigation />
            ...
            <Route path="/menu/at-home-coffee/whole-bean" exact render={(props) => <Menu {...props} menu={this.state["Whole Bean"]} />} />
            <Route path="/menu/at-home-coffee/verismo-pods" exact render={(props) => <Menu {...props} menu={this.state["Verismo Pods"]} />} />
            <Route path="/menu/at-home-coffee/via-instant" exact render={(props) => <Menu {...props} menu={this.state["VIA Instant"]} />} />
            <Route path="/menu/at-home-coffee/k-cup-pods" exact render={(props) => <Menu {...props} menu={this.state["K-Cup Pods"]} />} />
