...
class Menu extends Component {
    ...
    state = {
        ...
        "Whole Bean": [
            { "Starbucks Reverse": ["Rwanda Hingakawa Starbucks Reverse", "Sun-Dried Brazil Isidro Pereira Estate Starbucks Reverse", "Sun-Dried Papua New Guinea Ulya Starbucks Reverse", "Rwanda Abakundakawa Starbucks Reverse"] },
            { "Blond Roast": ["True North Blend", "Blonde Espresso"] },
            { "Medium Roast": ["Passport Series: West Java", "Siren's Blend", "Pike Place Roast", "Decaf Pike Place Roast"] },
            { "Dark Roast": ["Gold Coast Blend", "Passport Series: Anniversary Blend", "Komodo Dragon Blend", "Caffe Verona", "Sumatra", "Espresso Roast", "Starbucks Fairtrade Italian Roast"] }
        ],
        "Verismo Pods": [
            { "Brewed Coffee Verismo": ["True North Blend Verismo Pods", "Caffe Verona Verismo Pods", "Pike Place Roast Verismo Pods"] },
            { "Espresson Verismo": ["Blonde Espresso Verismo Pods", "Espresson Roast Verismo Pods", "Decaf Espresso Roast Verismo Pods"] }
        ],
        "VIA Instant": [
            { "Blonde Roast": ["VIA True North Blend"] },
            { "Medium Roast": ["VIA Colombia", "VIA Pike Place Roast"] },
            { "Dark Roast": ["VIA French Roast", "VIA Italian Roast", "VIA Decaf Italian Roast"] }
        ],
        "K-Cup Pods": [
            { "Medium Roast": ["Decaf Pike Place Roast K-Cup Pods"] }
        ]
    }
    render() {
        console.log(this.props.menu);
        // console.log(this.state.menu["sectionNames"]);
        // this.state.menu["sectionNames"].map(item => {
        //   console.log(item);
        ...
        return (
            <div className={classes.Container}>
                <div className={classes.Wrapper}>
                    ...
                    <Route path="/menu" exact render={(props) => <ElaboratedMenu {...props} menu={this.state.sectionNames} />} />
                    {/* <Route path="/menu" exact render={(props) => <ElaboratedMenu {...props} menu={this.props.menu} />} /> */}
                    

                    <Route path="/menu/drinks/hot-coffees" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Hot Coffees"]} />} />
                    <Route path="/menu/drinks/hot-teas" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Hot Teas"]} />} />
                    <Route path="/menu/drinks/hot-drinks" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Hot Drinks"]} />} />
                    <Route path="/menu/drinks/frappuccino-blended-beverages" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Frappuccino Blended Beverages"]} />} />
                    <Route path="/menu/drinks/cold-coffees" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Cold Coffees"]} />} />
                    <Route path="/menu/drinks/iced-teas" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Iced Teas"]} />} />
                    <Route path="/menu/drinks/cold-drinks" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Cold Drinks"]} />} />

                    <Route path="/menu/food/hot-breakfast" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Hot Breakfast"]} />} />
                    <Route path="/menu/food/bakery" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Bakery"]} />} />
                    <Route path="/menu/food/lunch" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Lunch"]} />} />
                    <Route path="/menu/food/snacks-&-sweets" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Snacks & Sweets"]} />} />

                    <Route path="/menu/at-home-coffee/whole-bean" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Whole Bean"]} />} />
                    <Route path="/menu/at-home-coffee/verismo-pods" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["Verismo Pods"]} />} />
                    <Route path="/menu/at-home-coffee/via-instant" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["VIA Instant"]} />} />
                    <Route path="/menu/at-home-coffee/k-cup-pods" exact render={(props) => <ElaboratedMenu {...props} menu={this.state["K-Cup Pods"]} />} />
